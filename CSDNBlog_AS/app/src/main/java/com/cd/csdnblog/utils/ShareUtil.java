...
public class ShareUtil {
    ...
    private static void initShare(Activity activity) {
        ...
        //添加微信分享
  		UMWXHandler wxHandler=new UMWXHandler(activity, "wx580fcffc9c85dae0", "d4624c36b6795d1d99dcf0547af5443d");
  		wxHandler.addToSocialSDK();
  		//添加微信朋友圈分享
  		UMWXHandler wxCircleHandler=new UMWXHandler(activity, "wx580fcffc9c85dae0", "d4624c36b6795d1d99dcf0547af5443d");
    ...
    public static void shareMusic(Activity activity, String description, String musicname,
        ...
        //        //设置分享图片
        //        qqShareContent.setShareImage(new UMImage(activity, R.mipmap.logo));
        //设置音频
        UMusic music = new UMusic(url);
        music.setTitle(musicname);
        music.setThumb(new UMImage(activity, R.mipmap.logo));
        ...
        //设置分享图片
        qzone.setShareImage(new UMImage(activity, R.mipmap.logo));
        //设置音频
        //        UMusic music = new UMusic(url);
    ...
    public static void shareOther(Activity activity, String description, String title, String url) {
        ...
        wxShareContent.setShareImage(new UMImage(activity, R.mipmap.logo));
        ...
        circleMedia.setShareImage(new UMImage(activity, R.mipmap.logo));
