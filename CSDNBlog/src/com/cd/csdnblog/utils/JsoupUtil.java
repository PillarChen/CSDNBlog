...
public class JsoupUtil {
	...
	public static List<BlogItem> getBlogItemList(int blogType, String str) {
		...
		String pagesStr = doc.getElementById("papelist").getElementsByClass("pagelist").get(0).text();
		pagesStr=RegexMatches.getStr(pagesStr);
		Log.i("pages", "--pagesStr--"+pagesStr);
		int pages=(Integer.parseInt(pagesStr)/20==0) ? Integer.parseInt(pagesStr)/20:Integer.parseInt(pagesStr)/20+1;
		Log.i("pages", "--pages--"+pages);
